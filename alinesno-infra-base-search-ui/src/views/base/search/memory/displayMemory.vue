         ...
         <el-col :span="12">
            <div class="grid-content">
               <div class="panel-body acp-height-auto">
                  ...
                  <div class="box-header">
                     <div class="sidecard-bar">
                        <div id="echarts-cloudword-chart" :style="{ width: '100%', height: '500px' }"></div>
                     </div>
                  </div>
                  <div class="body-desc">
                     记忆贡献度的统计数据包括事件提交、创建任务、更新、合并等会被统计。
         ...
         <el-col :span="12">
            <div class="grid-content">
               <div class="panel-body acp-height-auto">
                  ...
                  <div class="box-header">
                     <div class="sidecard-bar">
                        <div id="echarts-entityMapper-chart" :style="{ width: '100%', height: '500px' }"></div>
                     </div>
                  </div>
                  <div class="body-desc">
