    ...
    <el-row :gutter="20">
      ...
      <el-col :span="24" :xs="24">
        ...
        <el-table v-loading="loading" :data="DatasetKnowledgeList" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="文档名称" align="left" width="150" key="name" prop="name" v-if="columns[1].visible" :show-overflow-tooltip="true">
            <template #default="scope">
          ...
          <el-table-column label="数据数量" align="center" width="130" key="ownerId" prop="ownerId" v-if="columns[2].visible" :show-overflow-tooltip="true"/>
          <el-table-column label="文档描述" align="left" key="description" prop="description" v-if="columns[3].visible" :show-overflow-tooltip="true">
            <template #default="scope">
              <div>
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item  label="文档名称" prop="name">
              <el-input v-model="form.name" placeholder="请输入文档名称" maxlength="50"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
...
const data = reactive({
  ...
  rules: {
    datasetKnowledgeId: [{required: true, message: "应用编号不能为空", trigger: "blur"}],
...
function handleDelete(row) {
  ...
  proxy.$modal.confirm('是否确认删除应用编号为"' + datasetKnowledgeIds + '"的数据项？').then(function () {
